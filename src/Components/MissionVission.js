            ...
            <div className="container-fluid row">
                <div id="mission-vision-body" className="col-xl-4 col-lg-4 col-md-3 col-sm-6 col-xs-6">
                    <p className="mv-subheadline">OUR HISTORY</p>
                        ...
                        <img src={mission2img} className="d-md-block d-none mr-auto img-fluid h-25"></img>
                        <img src={mission3img} className="d-md-block d-none mr-auto img-fluid h-35"></img>
                        <img src={mission4img} className="d-md-block d-none mr-auto img-fuild h-45"></img>
