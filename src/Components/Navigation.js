      ...
      <nav id="navbar-header" className="navbar navbar-expand-lg navbar-light fixed-top">
        ...
        <div className="collapse navbar-collapse mt-lg-0 md-lg-0 mt-5" id="navbarNavAltMarkup">
          <div className="navbar-nav mr-auto">
            ...
            <HashLink to = "/foundation/#events-f-section" className="nav-item nav-link mr-md-1 text-center" onClick={this.closeMenuToggler}>FOUNDATION</HashLink>
          ...
          <div className="navbar-nav ml-auto">
            ...
            <HashLink to = "/franchise/#franchisee-section" className="nav-item nav-link mr-md-1 text-center" onClick={this.closeMenuToggler}>FRANCHISE</HashLink>
