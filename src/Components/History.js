                ...
                <div id="history-timeline" className="">
                    ...
                    <div id="history-section" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 justify-content">
                        <div id="history-card-left" className="row">
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-auto col-xs-auto pt-4 text-right">
                        ...
                        <div id="history-card-right" className="row">
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-auto col-xs-auto pt-4 text-right">
                        ...
                        <div id="history-card-right" className="row">
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 pt-4 text-right">
